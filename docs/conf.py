#!/usr/bin/env python
"""
rush documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "rush"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import rush.core  # noqa
...
project = "rush"
_full_version = rush.core.__version__
author = rush.core.__author__
copyright = rush.core.__copyright__
